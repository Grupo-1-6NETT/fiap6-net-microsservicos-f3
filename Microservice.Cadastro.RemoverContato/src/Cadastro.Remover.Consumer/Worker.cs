...
using Cadastro.Remover.Consumer.Models;

namespace Cadastro.Remover.Consumer;
public class Worker : BackgroundService
{
    ...
    {
        var contato = JsonSerializer.Deserialize<RemoverContatoRequest>(mensagem);

        using var httpClient = new HttpClient();

        string apiUrl = $"https://localhost:7095/Contatos/{contato.Id}";
        ...
        {
            Console.WriteLine($"Erro ao remover contato: {response.StatusCode}");
        }
